...
public class GameScript : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (!play)
        {
            ...
            if (GUI.Button(new Rect(Screen.width / 2 - 40, Screen.height - 40, 80, 20), "Play"))
            {
        ...
        else
        {
            ...
            GUI.Label(new Rect(Screen.width / 2 - 40, Screen.height - 40, 80, 40), "Light Level: " + logicScript.getLights());
            GUI.Label(new Rect(Screen.width - 90, Screen.height - 40, 80, 40), "Weapons Level: " + logicScript.getGun());
